...
namespace yb{
    ...
    std::vector<int> plantCostList = {100,50,175,50,25,150};
    std::vector<int> plantCoolTimeList = {75,100,125,100,300,100};
    std::vector<const char*>plantNameList={
    "PeaShooter","SunFlower","SnowPea","NutWall","PotatoMine","Chomper"
    };
